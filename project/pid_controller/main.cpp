...
int main ()
{
  ...
  **/
  PID pid_steer = PID();
  pid_steer.Init(0.35, 0.002, 0.11, 1.2, -1.2); // The output of the controller should be inside [-1.2, 1.2]
  ...
  **/
  ...
  pid_throttle.Init(0.08, 0.01, 0.035, 1.0, -1.0); // The output of the controller should be inside [-1, 1]
